...
csv_file_name = "test.csv" # file name that the program will create where HSV values will be written
file_dir = "/Users/abdulmueez/Desktop/Papers/TENSYMP/A-Cost-Effective-Framework-to-Predict-the-Ripeness-of-any-Fruit-Based-on-Color/Raspberry Pi/Timings/Test" # folder directory containing the images
